...
public class ValidacionesHemofilia {
    ...
    public String validacionV5(Map<String, String> parametros) {
        ...
        fechaMayorVariable.set(fechaMayorVariable.get(Calendar.YEAR) - 18, fechaMayorVariable.get(Calendar.MONTH),
        ...
        // ----------------------------------------3----------------------------------------
        if (parametros.get("tipoIdentificacionUsuario").equals("CC")
                && fecNacimientoUsuario.after(fechaMayorVariable)) {
    ...
    public String validacionV18(Map<String, String> parametros) {
        ...
        /* fila 204-205 */
        if ((parametros.get("usuarioProgramaPlanificacion").equals("3"))
                && (fechaV7.before(fechaVariable1) || fechaV7.after(fechaVariable2))) {
    ...
    public String validacionV21(Map<String, String> parametros) {
        ...
        if ((fechaV21.before(fechaVariable1) || fechaV21.after(fechaVariable2))
                && (parametros.get("fechaDiagnostico")
                        .matches(
                                "[1][8][0][0][-][0][1][-][0][1]|[1][8][1][1][-][0][1][-][0][1]|[1][8][4][6][-][0][1][-][0][1]") == false)) {
