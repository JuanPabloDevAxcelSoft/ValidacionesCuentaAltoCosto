...
public class CmVihPaso implements Serializable {
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof CmVihPaso)) {
            return false;
        }
        CmVihPaso other = (CmVihPaso) object;
