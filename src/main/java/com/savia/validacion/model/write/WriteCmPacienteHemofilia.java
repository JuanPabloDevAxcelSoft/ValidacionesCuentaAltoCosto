 ...
 */
@Entity
@Table(name = "cm_paciente_hemofilia")
public class WriteCmPacienteHemofilia implements Serializable {
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof WriteCmPacienteHemofilia)) {
            return false;
        }
        WriteCmPacienteHemofilia other = (WriteCmPacienteHemofilia) object;
    ...
    public String toString() {
        return "entity.WriteCmPacienteHemofiliaRepository[ id=" + id + " ]";
    }
