...
public class ReadCmPacienteHepatitisDos implements Serializable {
    ...
    public ReadCmPacienteHepatitisDos() {
    }

    public ReadCmPacienteHepatitisDos(Long id) {
        this.id = id;
    }

    public ReadCmPacienteHepatitisDos(Long id, int codigoIpsAtendido, Character tecnologiaSalud, Date fechaProcedimiento, String diagnosticosRelacionados, int codigoProcedimiento, float valorResultadoNum, String valorResultadoText, int codigoMedicamento, int loteMedicamento) {
        this.id = id;
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof ReadCmPacienteHepatitisDos)) {
            return false;
        }
        ReadCmPacienteHepatitisDos other = (ReadCmPacienteHepatitisDos) object;
    ...
    public String toString() {
        return "entity.ReadCmPacienteHepatitisDos[ id=" + id + " ]";
    }
