...
public class ReadCmPacienteHemofilia implements Serializable {
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof ReadCmPacienteHemofilia)) {
            return false;
        }
        ReadCmPacienteHemofilia other = (ReadCmPacienteHemofilia) object;
    ...
    public String toString() {
        return "entity.ReadCmPacienteHemofilia[ id=" + id + " ]";
    }
