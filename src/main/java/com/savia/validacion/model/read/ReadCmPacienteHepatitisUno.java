...
public class ReadCmPacienteHepatitisUno implements Serializable {
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof ReadCmPacienteHepatitisUno)) {
            return false;
        }
        ReadCmPacienteHepatitisUno other = (ReadCmPacienteHepatitisUno) object;
    ...
    public String toString() {
        return "entity.ReadCmPacienteHepatitisUno[ id=" + id + " ]";
    }
