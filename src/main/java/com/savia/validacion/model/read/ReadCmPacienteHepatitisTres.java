...
public class ReadCmPacienteHepatitisTres implements Serializable {
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof ReadCmPacienteHepatitisTres)) {
            return false;
        }
        ReadCmPacienteHepatitisTres other = (ReadCmPacienteHepatitisTres) object;
    ...
    public String toString() {
        return "entity.ReadCmPacienteHepatitisTres[ id=" + id + " ]";
    }
