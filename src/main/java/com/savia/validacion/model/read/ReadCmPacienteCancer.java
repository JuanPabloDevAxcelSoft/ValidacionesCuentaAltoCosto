...
public class ReadCmPacienteCancer implements Serializable {
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof ReadCmPacienteCancer)) {
            return false;
        }
        ReadCmPacienteCancer other = (ReadCmPacienteCancer) object;
    ...
    public String toString() {
        return "entity.ReadCmPacienteCancer[ id=" + id + " ]";
    }
