...
public class ReadCmPacienteArtritisReumatoide implements Serializable {
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof ReadCmPacienteArtritisReumatoide)) {
            return false;
        }
        ReadCmPacienteArtritisReumatoide other = (ReadCmPacienteArtritisReumatoide) object;
    ...
    public String toString() {
        return "entity.ReadCmPacienteArtritisReumatoide[ id=" + id + " ]";
    }
